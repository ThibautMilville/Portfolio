...
export default function ProjectsSection({ projects }: ProjectsSectionProps) {
  ...
  const featuredProjectTitles = ["UT Marketplace", "Institutional website OZC", "Commercial website OZC Signalétique"];
        ...
        {otherProjects.length > 0 && (
          ...
          >
            <div className="text-center mb-12">
              <h3 className="text-2xl font-bold mb-2">Dernières réalisations</h3>
              <p className="text-muted-foreground">Découvrez mes 15 derniers projets réalisés</p>
            </div>
