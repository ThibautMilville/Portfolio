...
import { Code2, Star, Palette, Server, Database, Tools } from 'lucide-react';
    ...
    <section className="py-20 px-6 relative">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground">Technologies et langages que je maîtrise</p>
        </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            {skillCategories.map((category, index) => (
              <motion.div
                ...
                className="group"
              >
                <div className={`p-6 rounded-2xl border border-border/50 bg-gradient-to-br ${category.color} hover:bg-card hover:border-primary/30 transition-all duration-300 h-full`}>
        ...
        >
          <div className="text-center mb-8">
            <h3 className="text-2xl md:text-3xl font-bold mb-4">Ma Stack Favorite</h3>
            <p className="text-lg text-muted-foreground">Les technologies que j'utilise au quotidien</p>
          </div>
        ...
        >
          <div className="text-center p-6 rounded-2xl border bg-card">
            <div className="text-2xl font-bold text-primary mb-1">{skills.length}+</div>
